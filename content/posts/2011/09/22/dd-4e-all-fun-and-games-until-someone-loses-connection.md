---
date: '2011-09-22T06:52:11-05:00'
draft: false
title: "D&D 4E: All fun and games until someone loses connection"
author: "Tipa"
disqusIdentifier: "2011/09/22/dd-4e-all-fun-and-games-until-someone-loses-connection"
...
Chris found a suite of free tools from [RPTools](http://rptools.net/) that seemed to solve the problem. There was a map maker, a character builder, a dice roller and so on. In our first session, we connected to Chris' server and played around with the tools while we rolled up our characters.
...
So... we went to a paid alternative, [Fantasy Grounds from Smite Works](http://www.fantasygrounds.com/). For $24, Fantasy Grounds promised a much better player and DM experience, with real 3D dice rolling (thankfully I had my 3D glasses with me), automatic handling of attacks and damage and powers and so on.
