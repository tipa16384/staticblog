...
- A persistent, consistent world. This is a virtual world that still exists for other players when you aren't playing, and is the same for all players. World of Tanks and other lobby-based games are not persistent. Minecraft is persistent, but the world is very different from server to server.- A unique player avatar. To be an MMO, the game should allow you to create your own avatar that other players will come to associate with you, the player. The explosion of 2D action "MMOs" where you chose your class and therefore your player avatar had the multiplayer part, but not the RPG part.- The ability to interact with other players -- the social aspect. Forming connections among players is probably an MMORPG's most important feature. That's the spark that keeps people logging in. It's why I still play DCUO after all these years.
