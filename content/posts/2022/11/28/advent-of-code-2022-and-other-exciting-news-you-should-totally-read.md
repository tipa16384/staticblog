...
author: "Tipa"
disqusIdentifier: "2022/11/28/advent-of-code-2022-and-other-exciting-news-you-should-totally-read"
...
But I finished. A couple days I got some help from other solvers, but I eventually wrote programs to solve every day, two parts. I learned a heck of a lot that I didn't know about the Python programming language, algorithms, data structures, and the behavior of submarines in the festive frozen waters beneath the North Pole.

I documented the whole thing on Twitter but, well, Twitter doesn't like me anymore, so I'm just going to post each day's results here.

And just to be sure that I don't get those solutions done too quickly, I will solve them in Python first -- just to get them done and on the leader board -- and then see how I can get them into PICO-8.
...
Hey, they're adding Starro for four player coop! Now I just need three friends who play the game.
...
From the notes about the update as written by a Thanksgiving turkey:

> As a Thanksgiving turkey, I can attest to the improvement of text-davinci-003 over text-davinci-002. The improved version of the text provides a more realistic and authentic representation of the turkey experience. It includes a more detailed and accurate description of the anatomy of a turkey, as well as more accurate depictions of turkey behavior. Additionally, the text-davinci-003 includes a more robust set of illustrations to help bring the turkey experience to life. All in all, these improvements give readers a clearer picture of the inner workings of a turkey, and ultimately make the text more enjoyable to read.
> Thanksgiving Turkey

**Guardian of the Galaxy Christmas Special spoilers**

Sure, you may know that the alien band in the movie was The Old 97s in makeup, but what you didn't know is that the lead singer was Rhett Miller.

I got the LEGO Advent Calendar version of the Christmas special so I will be probably posting that stuff on @Tipa@Masto.ai.
