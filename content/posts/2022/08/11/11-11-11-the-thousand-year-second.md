...
author: "Tipa"
disqusIdentifier: "2022/08/11/11-11-11-the-thousand-year-second"
...
**Number:** 11. **Genre:** Turn-based strategy game. **Title:** "11/11/11: The Thousand Year Second". **Outline:** On November 11th, 2011, a global event known as *The Standstill* occurred, freezing all of humanity in place. You are the leader of a group of alien scientists who arrive a thousand years later and must find the reason all humanity froze into place -- and how to rescue them.
...
This game is all about strategy: from choosing which aliens to bring on your team, to deciding when and how to use their unique abilities, to managing resources wisely. But it's also about relationships: between you and your teammates, between you and the people you're trying to rescue, and between you and the enemy. How you handle these relationships will be key to your success... or failure.

The enemies -- and possibly the reason humanity is frozen -- turn out to be dolphins, enhanced with alien technology. The final battle against the dolphins is a tough one, but if you can save humanity, the rewards will be great.
...
"11/11/11: The Thousand Year Second" is a turn-based strategy game played on a hexagonal grid. Each turn, you can move all of your units and take one action with each unit. Actions include attacking, using abilities, and picking up or dropping items.

There are three main resources in the game: alien energy, human food, and dolphin technology. Alien energy is used to power your units' abilities, human food is used to heal your units, and dolphin technology is used to build new units and upgrade existing ones.

When you attack an enemy unit, you'll enter into a battle scene. Battles are also turn-based, and each unit has a different set of moves they can make. Some moves will do more damage than others, but all moves have the potential to miss their target.
...
The "11/11/11: The Thousand Year Second" DLC adds a new scenario to the game in which you play as a human resistance fighter trying to overthrow the dolphin oppressors. This scenario features new maps, new units, and new abilities, as well as a brand-new ending.

"11/11/11: The Thousand Year Second" is available for PC, Mac, and Linux.
