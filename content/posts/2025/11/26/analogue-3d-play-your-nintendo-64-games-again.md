...
Paper Mario is arguably a 2D game :-)
...
• 100% compatibility with all original N64 cartridges, controllers, and accessories
• Region-free cartridge slot

**Video Output:**
• Native 4K HDMI (also supports 1080p)
• Zero-lag signal path
• NTSC & PAL compatible
• “Original Display Modes” — CRT, PVM, BVM recreation in 4K
• Variable refresh rate support

**Performance:**
• Cycle-accurate FPGA recreation of CPU, RSP, and RDP
• Built-in Expansion Pak and Memory Pak equivalents
• Accurate audio: 48 kHz, 16-bit PCM

**Controllers & I/O:**
• Four original-style controller ports
• Compatible with original accessories (Rumble Pak, Transfer Pak, VRU, etc.)
• Integrated support for the 8BitDo 64 Controller (sold separately)
• Controller firmware update capability via system
• Wireless support: Bluetooth Classic + LE, dual-band Wi-Fi
• 2× USB-A ports (wired controllers/charging)
• USB-C power input

**Operating System:**
• **3DOS** — redesigned Analogue OS for N64, in 4K
• OTA firmware updates via Wi-Fi
• System includes 16GB SD card for updates and OS storage
...
• HDMI cable
• USB cable
• 30W USB-C worldwide power supply (GaN, PD 3.0)

**Notable Limitations:**
• Not compatible with CRTs or the Analogue DAC
• Capture cards work only in non-CRT display modes (4K/1080p)
• Does **not** run ROM files; physical cartridges only
• Does not support openFPGA cores
