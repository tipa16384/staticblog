...
On the face of it, [La Brute](https://brute.eternaltwin.org/) is a simple game to get into. You create a "brute" from the limited customization options available, you head into the arena, you pick an opponent from a selection of six at your level, the two brutes fight for a bit, one wins and gets 2xp, the other loses and gets 1xp. You get six fights per day, and the game does not take much of your time.
