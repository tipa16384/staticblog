...
Some maniac has bought the Vectrex name and website and plans a [Kickstarter in November](https://vectrex.com/) to sell a new, mini version. The Vectrex was famously the only home console that used a built-in CRT monitor to display vector graphics, giving it a unique look and feel unmatched since.
