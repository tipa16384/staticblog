...
One goal I had, coming into [this year's Advent of Code](https://westkarana.blog/category/advent-of-code/), was to build enough expertise with [Lexaloffle's Picotron fantasy workstation](https://www.lexaloffle.com/picotron.php) so that I could start developing games there that would be easy to build and easy to share. I was pretty disappointed in how my *Sword for Hire* game came out last spring; I completed it (aside from some bugs) but I'd built it on Python in a terminal. That made me feel warm and fuzzy in an early 80s way, but it just was not portable.
