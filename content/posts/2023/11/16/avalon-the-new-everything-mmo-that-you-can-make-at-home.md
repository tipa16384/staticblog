...
For example, Butler said citing geek-culture references, Avalon’s filters would keep a player from using the DMC DeLorean from the Back to the Future franchise in a game based on the Star Trek universe." ([Decrypt](https://decrypt.co/205996/everquest-call-duty-vets-unveil-metaverse-game-avalon/))
