...
author: "Tipa"
disqusIdentifier: "2008/12/19/everquest-merging-servers-adding-new-server-in-2009"
summary: "Actually in an EverQuest group right now so can't write this up fully, but briefly, next month, Druzzil Ro (Tarew Marr) will merge with progression..."
categories:
  - "EverQuest"
  - "MMORPG"
relatedPosts:
...
---
Actually in an EverQuest group right now so can't write this up fully, but briefly, next month, Druzzil Ro (Tarew Marr) will merge with progression...
<!--more-->
