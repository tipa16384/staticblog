...
- Free episodes.- Standard daily login rewards (at least $20 in value when you log in at least 20 days per cycle).- Full access to lair and utility belt systems.- Cash cap increased from 2,000 to 50,000.- +7 additional inventory slots.- Promethium Lockboxes removed, their rewards distributed elsewhere.- Artifact XP items condensed to save inventory space.
...
- Additional 3x bonus daily login rewards (at least $60 in value when you log in at least 20 days per cycle).For daily login rewards, this means an extra three times the standard daily login rewards ($60 value) PLUS the standard daily login rewards everyone gets ($20 value), for a total of $80.
- +50% bonus to timed drops of Artifact XP and Ally XP.- +7 (more) Inventory slots (28 from membership, 77 total)- +8 (more) Bank slots (32 from membership, 56 total)- +7 (more) Shared Bank slots (7 from membership, 16 total)
