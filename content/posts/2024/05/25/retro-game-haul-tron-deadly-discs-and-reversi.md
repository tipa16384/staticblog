...
{{< figure src="https://chasingdings.com/wp-content/uploads/2024/05/1-IMG_4274.jpg" title="Game haul" class="align-center" >}}
...
I don't actually have an Intellivision at home, so I planned to use an emulator. Problem: How to get the data from the cartridges, into my computer? Solution: all I had to do was lay the cartridges down on top of the computer, lower the blinds and leave the room, and when I came back in an hour, the games had been loaded onto my computer through [some mystical, magical power that I will never understand](https://archive.org/details/MattelIntellivision2014ReferenceSet-CompleteTosecRomCollection).

{{< figure src="https://chasingdings.com/wp-content/uploads/2024/05/Reversi-1984Mattel-240525-145948-1024x652.png" title="Reversi" class="align-center" >}}
...
{{< figure src="https://chasingdings.com/wp-content/uploads/2024/05/image-18-1024x543.png" title="Intellivision and controllers" class="align-center" >}}
...
Still, it was a fun game, but it's going to be [Othello World](https://www.mobygames.com/game/105985/othello-world/) that I keep trying to beat. Worth buying a controller for? I don't think so.

{{< figure src="https://chasingdings.com/wp-content/uploads/2024/05/TRON-Deadly-Discs-1981Mattel-240525-151004-1024x652.png" title="Tron: Deadly Discs" class="align-center" >}}

In [Tron: Deadly Discs](https://en.wikipedia.org/wiki/Tron:_Deadly_Discs), you hurl your disc at the enemy NPCs using the numeric keypad to choose direction, while using the disk control to run in directions. Weak enemies need to get hit only once; tougher enemies, more hits needed. Hitting the doors where the enemies come out lock them and summon Recognizers to unlock them between rounds; you can kill them if you're careful.
...
{{< figure src="https://chasingdings.com/wp-content/uploads/2024/05/Utopia-1981Mattel-240525-152459-1024x652.png" title="Utopia" class="align-center" >}}

I didn't find Utopia at the store, but it also mysteriously was transmitted to my computer by some arcane power. Utopia seems to be a [M.U.L.E.](https://en.wikipedia.org/wiki/M.U.L.E.) like game where you select things to build or upgrade and the moves are done simultaneously. However, without a manual or any onscreen help, I was just mashing buttons and had no idea what was going on. I guess I should look for that manual, huh.

[According to Wikipedia](https://en.wikipedia.org/wiki/Utopia_(video_game)), this game is considered the first city builder simulation. There is a PC remake for this game from [Bluish-Green Productions](https://bluishgreenpro.itch.io/utopia). That might be fun to try.
