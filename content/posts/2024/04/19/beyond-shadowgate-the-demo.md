...
It's a little weird that this version of "Beyond Shadowgate" doesn't appear to have anything to do with the [*other* game](https://en.wikipedia.org/wiki/Beyond_Shadowgate), also called "Beyond Shadowgate". From what the wiki says, there's nothing connecting that game to this one. You'd think they'd have called it "Beyond**er** Shadowgate", or something.
