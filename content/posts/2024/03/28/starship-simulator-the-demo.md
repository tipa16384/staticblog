...
[Starship Simulator](https://starshipsimulator.co.uk/), currently [live on Kickstarter](https://www.kickstarter.com/projects/fleetyard/starship-simulator) with a [demo available on Steam](https://store.steampowered.com/app/1332100/Starship_Simulator/), has a simple premise: You're on a starship. You have a job to do (if you want a job) -- you can be the captain, the pilot, an engineer, or just a bartender, but every job on the ship is vital. You're a member of the crew, and each one of you is necessary in some way to the safe operation of the ship. And, you can go anywhere in the galaxy.
