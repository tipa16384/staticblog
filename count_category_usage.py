...
if __name__ == '__main__':
    xml_file = 'chasingdings.WordPress.2026-01-26.xml'
    csv_file = 'categories_normalized.csv'
    output_file = 'category_usage_count.csv'
    
    count_normalized_category_usage(xml_file, csv_file, output_file)